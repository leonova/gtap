									...
									<div class="tab-content">
									  ...
									  <div class="childcontent">
										...
										for ($x=0;$x<$childrencount;$x++){		
											...
											$y++;
										?>
										<form method="post" enctype="multipart/form-data" name="fileupload_<?php echo $y; ?>" id="fileupload_<?php echo $y; ?> class="childform"">
										...
										<form  method="post" enctype="multipart/form-data" name="update_child_data_<?php echo $y; ?>" id="update_child_data_<?php echo $y; ?>">
											...
											<input type="hidden" id="objectId" name="objectId" value="<?php echo $childrenvalue[$x]['objectId'];?>">
										  	...
										  	<p><button type="button" class="btn btn-default" id="uploadbutton_<?php echo $y; ?>" name="uploadbutton_<?php echo $y; ?>" value="<?php echo $y; ?>" onclick="updateChildInfo('<?php echo $y; ?>');">Save</button></p>										
									  	</form>
										</div>
										
										<?php }?>
										<div id="addchild"></div>
										<p style="padding-top:20px;"><button type="button" class="btn btn-default" id="AddChild-btn">Add Child</button></p>
