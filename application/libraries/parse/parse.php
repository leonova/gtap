...
class parseRestClient{
	...
	private $_appid = '5OZPunpgNbKfWoI1jNLc8WGLjtdIyhGLHMHBasS8';
	private $_masterkey = 'ns31cCkhVRl6oHODisthdnZ4WzA7BIC9NLvjBMIv';
	private $_restkey = 'LyvPgHupYyUHZMsksfeUcaDfqvJajiodoCv0O1N9';
	private $_parseurl = 'https://api.parse.com/';
	...
	public function request($args){
		...
		$res=$this->checkResponse($response,$responseCode,$expectedCode);
